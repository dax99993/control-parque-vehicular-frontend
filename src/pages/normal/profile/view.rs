...
pub fn NormalProfileView() -> Html {
    ...
    let user = use_state(|| user_ctx.get_user().expect("No hay usuario almacenado!"));
    ...
    html!{
        <MainSection route="Admin" subroute="Perfil" title="Editar Perfil">
            <div class="tile is-ancestor">
                ...
                <div class="tile is-parent">
                    <ProfileInfo usuario_state={user.clone()}/>
                </div>
            </div>
            <ChangePassword/>
        </MainSection>
